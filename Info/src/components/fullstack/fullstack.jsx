    ...
    return (
        <main>
            <div className="fullStack">
                ...
                <div className="principalesFs">
                    <div className="equipo">
                        ...
                        <p>Desarrolladores escriben aqui quiénes son</p>
                    </div>
                ...
                <div className="textoFront">
                    ...
                    <div className="textosFront">
                        <p className="textoDos">
                            ...
                            a nuestra plataforma. Para asegurar la privacidad y
                            ...
                            reservados para usuarios registrados. Las
                            coordenadas de los puntos de recogida de aguas se
                ...
                <div className="textoDeploy">
                    ...
                    <div className="textosDeploy">
                        <p className="textoDos">
                            ...
                            se envía y recibe en nuestra plataforma. Un
                            beneficio adicional de utilizar Docker es la
                    ...
                    <div className="dataLink">
                        <a href="">
                            <img
                                ...
                                src="../../static/fullstack/vectords.png"
                                alt="vector data"
                            />
                            <p>DATA SCIENCE</p>
                        </a>
                ...
                <div className="uxui">
                    ...
                    <div className="uxuiLink">
                        <a href="">
                            <img
                                className="vectorux"
                                src="../../static/fullstack/vectoruxui.png"
                                alt="vector ux"
                            />
                            <p>UX/UI DESIGN</p>
                        </a>
            ...
            <div className="agradecimientos">
                <h4>
                    El equipo te da las gracias por haber llegado hasta aquí
                </h4>
            </div>
        </main>
    );
