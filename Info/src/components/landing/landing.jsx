    ...
    return (
        <main>
            <section className="grisLanding">
                <h1>APPÚRATE.ORG</h1>
                <p>El viernes 15 de septiembre, tuvo lugar la reunión y presentación del desafío en colaboración con <strong>AQUADAT</strong>. Durante este encuentro, se nos brindó una detallada exposición del desafío en cuestión, así como se delinearon los objetivos a alcanzar.</p>
            </section>
            <section className="blancoLanding">
                <section className="columna1Landing">
                    <article className="estrategia">
                        <h3>ESTRATEGIA, CREATIVIDAD Y VIABILIDAD DEL PROYECTO</h3>
            ...
            <div className="blanco2landing">
                ...
                <div className="disenoSitemap">
                    <h4>Luego de estas consideraciones, nos adentramos en el diseño del sitemap, donde identificamos tres componentes fundamentales o bloques clave para la webapp.</h4>
                </div>
            ...
            <div className="gris3landing">
                <div className="azul">
                    ...
                    <div className="equipo">
                        ...
                        <ul>
                            <li>
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente ab ipsa perferendis iure ad corrupti sequi quo corporis. Repellendus, cumque.
                            </li>

                            <li>
                                Laborum delectus repudiandae facilis commodi veniam repellat. Quisquam, voluptas debitis.
                            </li>
                            <li>
                                Laboriosam, quis magnam? Quosque tandem abutere patientiam nostram, Catilina?
                            </li>
                        </ul>
                    </div>
