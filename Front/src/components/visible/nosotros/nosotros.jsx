            ...
            <div className="aboutGeneral">
                <div className="ayudando">
                    <div>
                        ...
                        <p>
                            Nuestra solución educativa tiene como objetivo
                            empoderar a los jóvenes para que aprendan, exploren
                            y tomen conciencia sobre la calidad del agua en su
                            ciudad.Los estudiantes podrán registrar datos de
                            muestras de agua, visualizarlos en un formato fácil
                            de entender y acceder a información educativa sobre
                            contaminantes comunes y cómo afectan la salud
                            humana.{" "}
                        </p>
                    </div>
                    <div>
                ...
                <div className="forma">
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            profesores se utilizarán para identificar problemas
                            en la calidad del agua, informar a las autoridades
                            locales, crear conciencia en la comunidad y promover
                            cambios de comportamiento positivos. Creemos que al
                            involucrar a los jóvenes en el proceso de toma de
                            muestras y análisis de datos, estarán mejor
                            equipados para comprender y proteger la calidad del
                ...
                <div className="tratando">
                    <div>
                        ...
                        <p>
                            ...
                            elit. Facilis ducimus obcaecati voluptatem
                            voluptate, placeat facere cum maiores quo quibusdam
                            officia temporibus dolorem a laudantium velit, odit
                            autem ratione assumenda dolore.
                        </p>
                    </div>
                    <div>
                        <img
